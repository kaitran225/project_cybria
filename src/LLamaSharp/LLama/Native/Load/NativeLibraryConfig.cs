...
namespace LLama.Native
{
    ...
    public sealed partial class NativeLibraryConfig
    {
        ...
        /// <summary>
        /// When true, use the pure C# backend (no native llama.dll). Must be set before any LLamaSharp native API is used.
        /// Pure C# backend is a port of llama.cpp inference to C#; no P/Invoke required.
        /// </summary>
        public static bool UsePureCSharpBackend { get; set; }
